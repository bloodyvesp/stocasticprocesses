...
\end{align}
    \subsection{Inciso 1}
        \input{parcial2/problema3/incisop2_3_1.tex}
        \newpage
        
    \subsection{Inciso 2}
        \input{parcial2/problema3/incisop2_3_2.tex}
        \newpage
        
    \subsection{Inciso 3}
        \input{parcial2/problema3/incisop2_3_3.tex}
        \newpage
        
    \subsection{Inciso 4}
        \input{parcial2/problema3/incisop2_3_4.tex}
        \newpage
...
A las identidades anteriores se les conoce como condición de balance detallado.
    \subsection{Inciso 1}
        \input{parcial2/problema4/incisop2_4_1.tex}
        \newpage
        
    \subsection{Inciso 2}
        \input{parcial2/problema4/incisop2_4_2.tex}
        \newpage
        
    \subsection{Inciso 3}
        \input{parcial2/problema4/incisop2_4_3.tex}
        \newpage
        
    \subsection{Inciso 4}
        \input{parcial2/problema4/incisop2_4_4.tex}
        \newpage
        
    \subsection{Inciso 5}
        \input{parcial2/problema4/incisop2_4_5.tex}
        \newpage