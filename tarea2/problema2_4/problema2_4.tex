...
\begin{proof}
    ...
    \input{tarea2/problema2_4/inciso2_4_1.tex}
    \newpage
    
    \subsection{Inciso (ii)}    \label{problema2_4:inciso2}
    \input{tarea2/problema2_4/inciso2_4_2.tex}
    \newpage
        
    \subsection{Inciso (iii)}    \label{problema2_4:inciso3}
    \input{tarea2/problema2_4/inciso2_4_3.tex}
    \newpage
    
    \subsection{Inciso (iv)}    \label{problema2_4:inciso4}
    \input{tarea2/problema2_4/inciso2_4_4.tex}
\end{proof}