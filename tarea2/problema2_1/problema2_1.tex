\begin{problema}
        ...
        El objetivo del ejercicio es determinar la distribuci\'on de $M_p$.\pn
        ...
        Este ejercicio es el resultado b\'asico del estudio de sus extremos, denominado teor\'ia de fluctuaciones.)\pn
...
\begin{proof}
    ...
    \input{tarea2/problema2_1/inciso2_1_1.tex}
    \newpage
    
    \subsection{Inciso (ii)}    \label{problema2_1:inciso2} 
    \input{tarea2/problema2_1/inciso2_1_2.tex}
    \newpage
        
    \subsection{Inciso (iii)}    \label{problema2_1:inciso3}
    \input{tarea2/problema2_1/inciso2_1_3.tex}
    \newpage
    
    \subsection{Inciso (iv)}    \label{problema2_1:inciso4}
    \input{tarea2/problema2_1/inciso2_1_4.tex}
\end{proof}