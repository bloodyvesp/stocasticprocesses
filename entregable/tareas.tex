...
\begin{document}
    ...
    \part*{Notas}\label{notas}
        ...
        Si no es posible recompilar este documento gracias a la librería para manejar archivos adjuntos, comente las lineas $20$ y $100$ del archivo 
