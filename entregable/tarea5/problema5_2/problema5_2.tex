...
%Simulaci\'on de un proceso Poisson puntual... subordinador...
    ...
    \begin{enumerate}[resume]
        \item[(iii)]	[\ref{problema5_2:inciso3}] 
			Calcule $\esp{e^{-\lambda X_t}}$ y pruebe que $X_{t}$ tiene la misma distribuci\'on que $t^{1/\alpha}X_1$.\pn 
        \item[(iv)]		[\ref{problema5_2:inciso4}] 
			Diga por qu\'e el siguiente c\'odigo en Octave simula la trayectoria aproximada del proceso $X$ en el intervalo $[0,1]$.\pn
			\texttt{
...
\begin{proof}
	...
	\input{tarea5/problema5_2/inciso5_2_1.tex}
	\newpage
	
	\subsection{Inciso (ii)}	\label{problema5_2:inciso2}
	\input{tarea5/problema5_2/inciso5_2_2.tex}
	\newpage
	
	\subsection{Inciso (iii)}	\label{problema5_2:inciso3}
	\input{tarea5/problema5_2/inciso5_2_3.tex}
	\newpage
	
	\subsection{Inciso (iv)}	\label{problema5_2:inciso4}
	\input{tarea5/problema5_2/inciso5_2_4.tex}
\end{proof}