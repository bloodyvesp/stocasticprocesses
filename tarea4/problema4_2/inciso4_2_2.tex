...
Tenemos que demostrar que para $m \in \Z$, $\{ C_n = m \} \in \F_m$.\par\null
...
$\{ C_n < k\} = \emptyset$, en particular, si $m < k$, $\{C_n = m\} = \emptyset \in \F_m$.\par\null
...
al intesectar con dicho conjunto, las preimagenes de $S_{C_i}$ pertenecen a $\F_m$).\par\null
